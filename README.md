...
| ***kubectl_context_user***         | `None`        | Applys the manifests to the kubectl cluster context, defaults to k8s_deploy.cluster
| ***kubectl_context_cluster***      | `None`        | Applys the manifests to the kubectl cluster user, defaults to k8s_deploy.user
| ***gitops_directory_structure***      | `{namespace}/{cluster}`        | The directory structure under `gitops_path` to place manifests
